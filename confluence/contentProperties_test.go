...
func TestContentPropertyService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/9438383838383/property",
...
func TestContentPropertyService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/9438383838383/property?expand=expand-00%2Cexpand-01&limit=50&start=0",
			context:            context.Background(),
...
func TestContentPropertyService_Delete(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/9438383838383/property/editor",
			context:            context.Background(),
