...
func TestContentLabelService_Add(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/48483737372/label?use-400-error-response=true",
...
func TestContentLabelService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/3483373/label?limit=50&prefix=global&start=0",
			context:            context.Background(),
...
func TestContentLabelService_Remove(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/3483373/label/global",
			context:            context.Background(),
