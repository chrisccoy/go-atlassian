...
func TestContentRestrictionOperationService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/233838383/restriction/byOperation?expand=restrictions.user%2Crestrictions.group",
...
func TestContentRestrictionOperationService_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/content/233838383/restriction/byOperation/read?expand=restrictions.user%2Crestrictions.group&limit=50&start=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
		},
