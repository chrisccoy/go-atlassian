...
func TestContentRestrictionService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/233838383/restriction?expand=restrictions.user%2Crestrictions.group&limit=50&start=0",
...
func TestContentRestrictionService_Add(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/233838383/restriction?expand=restrictions.user%2Crestrictions.group",
			context:            context.Background(),
