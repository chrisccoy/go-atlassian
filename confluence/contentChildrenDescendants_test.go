...
func TestContentChildrenDescendantService_Children(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/3958383/child?expand=page%2Ccomments&parentVersion=3",
...

		{
			...
			mockFile:           "./mocks/get-content-children.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/content/3958383/child?parentVersion=3",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestContentChildrenDescendantService_ChildrenByType(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/content/33473773/child/page?expand=childTypes.all&limit=50&parentVersion=1&start=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestContentChildrenDescendantService_Descendants(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-content-children.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/content/3958383/descendant?expand=page%2Ccomments",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...

		{
			...
			mockFile:           "./mocks/get-content-children.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/content/3958383/descendant",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestContentChildrenDescendantService_DescendantsByType(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-contents.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/content/33473773/descendant/page?depth=1&expand=childTypes.all&limit=50&start=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestContentChildrenDescendantService_CopyHierarchy(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/44747372/pagehierarchy/copy",
			context:            context.Background(),
...
func TestContentChildrenDescendantService_CopyPage(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/content/747366262/copy?expand=childTypes.all%2Ccontainer",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
