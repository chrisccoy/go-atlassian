...
func Test_Content_Version_Service_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/233838383/version?expand=restrictions.user%2Crestrictions.group&limit=50&start=0",
...
func Test_Content_Version_Service_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/content/233838383/version/0?expand=collaborators%2Ccontent",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
		},
...
func Test_Content_Version_Service_Restore(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/233838383/version?expand=collaborators%2Ccontent",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
		},
...
func Test_Content_Version_Service_Delete(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/content/233838383/version/0",
			context:            context.Background(),
