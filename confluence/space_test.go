...
func TestSpaceService_Gets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			endpoint:           "/rest/api/space?expand=operations&favorite=true&favouriteUserKey=DUMMY&label=label-09%2Clabel-02&limit=50&spaceId=1111&spaceId=2222&spaceId=3333&spaceKey=DUMMY&spaceKey=TEST&start=0&status=archived&type=global",
...
func TestSpaceService_Create(t *testing.T) {
	...
	testCases := []struct {
...

		{
			...
			mockFile:           "./mocks/get-space.json",
			wantHTTPMethod:     http.MethodPost,
			endpoint:           "/rest/api/space/_private",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusCreated,
			wantErr:            false,
		},
...
func TestSpaceService_Get(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockFile:           "./mocks/get-space.json",
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/space/DUMMY?expand=childtypes.all%2Coperations",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestSpaceService_Content(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/space/DUMMY/content?depth=all&expand=operations&limit=50&start=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
...
func TestSpaceService_ContentByType(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantHTTPMethod:     http.MethodGet,
			endpoint:           "/rest/api/space/DUMMY/content/page?depth=all&expand=operations%2Crestrictions&limit=50&start=0",
			context:            context.Background(),
			wantHTTPCodeReturn: http.StatusOK,
			wantErr:            false,
		},
